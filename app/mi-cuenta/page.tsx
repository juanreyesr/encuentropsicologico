...
export default async function AccountPage() {
  ...
  const [regResponse, resourceResponse, certificateResponse, capacityResponse, profileResponse, directoryResponse] = await Promise.all([
  ...
  return <main className="account-page">
    ...
    <section>
      ...
      <AccountNameEditor initialName={registrations[0]?.name ?? user.email} />
