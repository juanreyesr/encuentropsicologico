...
type DashboardData = {
  ...
  metrics: { total: number; presencial: number; virtual: number; waitlist: number; available: number; capacity: number; students?: number; professionals?: number; networkOptIns?: number; sharedDirectory?: number; guatemala?: number };
