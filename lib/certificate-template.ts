...
@media print{html,body{width:11in;height:8.5in;background:#fff}.signature .seal{height:auto;-webkit-print-color-adjust:exact;print-color-adjust:exact}.signature .seal-right{width:1.45in}.signature .seal-left{width:.95in}.diploma{width:11in;height:8.5in;min-height:0;padding:.22in;background:#fff}.frame{width:100%;height:100%;aspect-ratio:auto;padding:.36in .58in;outline-offset:-.17in}.brand img{width:1.28in;height:1.28in}.brand p{font-size:10px}.brand span{font-size:10px}.event{font-size:16px}.title{font-size:38px}.lead{font-size:14px;margin-top:.15in}.name{font-size:34px;margin:.11in auto}.meta{font-size:12px;margin-top:.1in}.certificate-footer{margin-bottom:.12in}.signatures{margin:.12in auto .1in}.signature{min-height:.82in}.signature img{height:.52in}.signature b{font-size:12px}.signature small{font-size:10px}.logos{min-height:.5in;gap:.18in}.logos img{width:1.48in;height:.5in}}
