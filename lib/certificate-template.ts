...
.brand{display:flex;justify-content:center;align-items:center;gap:15px;color:#8b6417}.brand img{width:76px;height:76px;object-fit:contain}.brand p{margin:0;font-size:12px;font-weight:700;letter-spacing:.21em}.brand span{display:block;margin-top:5px;font:italic 13px Georgia,serif;color:#65527d}
...
@media(max-width:640px){.diploma{padding:8px}.frame{outline-width:6px;outline-offset:-14px;padding:22px 26px}.brand img{width:48px;height:48px}.brand p{font-size:8px}.event{font-size:14px}.title{font-size:28px}.certificate-footer{transform:translateY(-8px)}.signatures{gap:24px;width:92%;margin-bottom:8px}.signature{min-height:72px}.signature img{height:42px}.signature b{font-size:11px}.signature small{font-size:8px}.logos{gap:10px;min-height:38px}.logos img{width:84px;height:32px}}
@media print{html,body{width:11in;height:8.5in;background:#fff}.diploma{width:11in;height:8.5in;min-height:0;padding:.22in;background:#fff}.frame{width:100%;height:100%;aspect-ratio:auto;padding:.36in .58in;outline-offset:-.17in}.brand img{width:.64in;height:.64in}.brand p{font-size:10px}.brand span{font-size:10px}.event{font-size:16px}.title{font-size:38px}.lead{font-size:14px;margin-top:.15in}.name{font-size:34px;margin:.11in auto}.meta{font-size:12px;margin-top:.1in}.certificate-footer{transform:translateY(-.12in)}.signatures{margin:.12in auto .1in}.signature{min-height:.82in}.signature img{height:.52in}.signature b{font-size:12px}.signature small{font-size:10px}.logos{min-height:.5in;gap:.18in}.logos img{width:1.48in;height:.5in}}
