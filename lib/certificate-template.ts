...
.signature.with-seal{position:relative}.signature .seal{position:absolute;top:50%;height:auto;width:clamp(120px,13.5vw,178px);mix-blend-mode:multiply;opacity:.94;pointer-events:none;z-index:2}.signature .seal-right{left:50%;transform:translate(0,-62%) rotate(-4.5deg)}.signature .seal-left{left:-19%;transform:translate(-50%,-62%) rotate(-3.5deg)}
