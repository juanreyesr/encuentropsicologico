...
export function buildCertificateHtml({
  ...
  const seal = template.seal_enabled && template.seal_url ? template.seal_url : "";
  ...
  const sealHtml = seal ? `<img class="seal" src="${escapeHtml(seal)}" alt="Sello institucional" />` : "";
